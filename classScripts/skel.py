...
class BaseSkel(object):
    ...
    def nameXjoint(self, folder):
        ...
        for item in longnames[::-1]:   # this is shorthand for 'walk through the list backwards'
            ...
            pm.rename(item, shortname.replace("_JNT","_X_JNT"))
    ...
    @my_decorator
    def tPose(self):
        pm.setAttr("r_shoulder1_X_JNT.rotateY", 19)
        pm.setAttr("r_shoulder1_X_JNT.rotateZ", 66)
        pm.setAttr("r_elbow1_X_JNT.rotateZ", -31)

        pm.setAttr("l_shoulder1_X_JNT.rotateY", 19)
        pm.setAttr("l_shoulder1_X_JNT.rotateZ", 66)
        pm.setAttr("l_elbow1_X_JNT.rotateZ", -31)
