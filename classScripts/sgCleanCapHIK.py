...
class CleanCapHIK(object):
    ...
    def linkCapHIK(self, name1):
        ...
        mel.eval('setCharacterObject("{}","{}",1,0);'.format(self.capBones.values()[0], name1)) 
        mel.eval('setCharacterObject("{}","{}",8,0);'.format(self.capBones.values()[1], name1))
        mel.eval('setCharacterObject("{}","{}",23,0);'.format(self.capBones.values()[2], name1))
        mel.eval('setCharacterObject("{}","{}",20,0);'.format(self.capBones.values()[3], name1))
        mel.eval('setCharacterObject("{}","{}",15,0);'.format(self.capBones.values()[4], name1))
        mel.eval('setCharacterObject("{}","{}",18,0);'.format(self.capBones.values()[5], name1))
        mel.eval('setCharacterObject("{}","{}",9,0);'.format(self.capBones.values()[6], name1))
        mel.eval('setCharacterObject("{}","{}",10,0);'.format(self.capBones.values()[7], name1))
        mel.eval('setCharacterObject("{}","{}",11,0);'.format(self.capBones.values()[8], name1))
        mel.eval('setCharacterObject("{}","{}",19,0);'.format(self.capBones.values()[9], name1))
        mel.eval('setCharacterObject("{}","{}",12,0);'.format(self.capBones.values()[10], name1))
        mel.eval('setCharacterObject("{}","{}",13,0);'.format(self.capBones.values()[11], name1))
        mel.eval('setCharacterObject("{}","{}",14,0);'.format(self.capBones.values()[12], name1))
        mel.eval('setCharacterObject("{}","{}",3,0);'.format(self.capBones.values()[13], name1))
        mel.eval('setCharacterObject("{}","{}",4,0);'.format(self.capBones.values()[14], name1))
        mel.eval('setCharacterObject("{}","{}",5,0);'.format(self.capBones.values()[15], name1))
        mel.eval('setCharacterObject("{}","{}",16,0);'.format(self.capBones.values()[16], name1))
        mel.eval('setCharacterObject("{}","{}",5,0);'.format(self.capBones.values()[17], name1))
        mel.eval('setCharacterObject("{}","{}",6,0);'.format(self.capBones.values()[18], name1))
        mel.eval('setCharacterObject("{}","{}",7,0);'.format(self.capBones.values()[19], name1))
        mel.eval('setCharacterObject("{}","{}",17,0);'.format(self.capBones.values()[20], name1))
